...
- Minimal Debian 13 and Fedora 42 container checks validate non-Ubuntu distribution detection and prerequisite guidance. They do not claim systemd, udev, USB, or physical-device validation.
